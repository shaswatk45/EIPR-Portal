...
// Self-contained class merge helper replacing @/lib/utils
...
function MiniNavbar() {
  ...
  return (
    <header className={`fixed top-6 left-1/2 transform -translate-x-1/2 z-20
                       ...
                       pl-6 pr-6 py-3 backdrop-blur-[20px]
                       ${headerShapeClass}
                       border border-white/10 bg-[#16120e]/50
      ...
      <div className="relative z-10 flex flex-col flex-1">
        ...
        <div className="flex flex-1 flex-col lg:flex-row ">
          ...
          <div className="flex-1 flex flex-col justify-center items-center p-4">
            <div className="w-full mt-[150px] max-w-md bg-[#16120e]/55 backdrop-blur-[24px] border border-white/10 rounded-2xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
